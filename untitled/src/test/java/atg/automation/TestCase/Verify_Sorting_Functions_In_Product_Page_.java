...
public class Verify_Sorting_Functions_In_Product_Page_ extends WebDriverTestNGSetupBase {
    ...
    /**
     * Test case to test default sort by product Name from A to Z
     */
    @Test(alwaysRun = true)
    ...
    /**
     * Test case to test sort by product name from Z to A
     */
    @Test(alwaysRun = true)
    ...
    /**
     * Test case to test sort by Product Price from high to low
     */
    @Test(alwaysRun = true)
    ...
    /**
     * Test case to test sort by Product price from low to high
     */
    @Test(alwaysRun = true)
